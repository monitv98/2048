alert('Si está en una PC, puede usar flechas o deslizar el mouse \ nEn teléfonos use deslizar \ n \ nPresione R para reiniciar el juego \ n \ nPresione C para cambiar de tema \ nEl tema oscuro se activa automáticamente de 20:00 a 7: 00 ')
